...
final class RY_SmilePay_Gateway_Cvs_Fami_Blocks_Support extends AbstractPaymentMethodType
{
    ...
    {
        $script_asset = include RY_WTP_PLUGIN_DIR . 'assets/js/blocks/gateways/smilepay/cvs-fami.asset.php';

        wp_register_script('ry-smilepay-cvs-fami-block', RY_WTP_PLUGIN_URL . 'assets/js/blocks/gateways/smilepay/cvs-fami.js', $script_asset['dependencies'], $script_asset['version'], true);
