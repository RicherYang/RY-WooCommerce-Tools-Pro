...
final class RY_SmilePay_Gateway_Webatm_Blocks_Support extends AbstractPaymentMethodType
{
    private $gateway;
    ...
    {
        $script_asset = include RY_WTP_PLUGIN_DIR . 'assets/js/blocks/gateways/smilepay/webatm.asset.php';

        wp_register_script('ry-smilepay-webatm-block', RY_WTP_PLUGIN_URL . 'assets/js/blocks/gateways/smilepay/webatm.js', $script_asset['dependencies'], $script_asset['version'], true);
