...
final class RY_SmilePay_Gateway_Cvs_711_Blocks_Support extends AbstractPaymentMethodType
{
    ...
    {
        $script_asset = include RY_WTP_PLUGIN_DIR . 'assets/js/blocks/gateways/smilepay/cvs-711.asset.php';

        wp_register_script('ry-smilepay-cvs-711-block', RY_WTP_PLUGIN_URL . 'assets/js/blocks/gateways/smilepay/cvs-711.js', $script_asset['dependencies'], $script_asset['version'], true);
