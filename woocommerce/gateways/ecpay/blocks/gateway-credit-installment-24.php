...
{
    protected $name = RY_ECPay_Gateway_Credit_Installment_24::ID;
    ...
    public function get_payment_method_script_handles()
    {
        ...
        wp_localize_script('ry-ecpay-credit-installment-24-block', 'RyEcpayCreditInstallment24BlockParams', [
            'defaultTitle' => __('ECPay Credit (24 installment)', 'ry-woocommerce-tools-pro'),
        ]);
