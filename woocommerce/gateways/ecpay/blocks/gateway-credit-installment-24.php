...
final class RY_ECPay_Gateway_Credit_Installment_24_Blocks_Support extends AbstractPaymentMethodType
{
    ...
    {
        $script_asset = include RY_WTP_PLUGIN_DIR . 'assets/js/blocks/gateways/ecpay/credit-installment-24.asset.php';

        wp_register_script('ry-ecpay-credit-installment-24-block', RY_WTP_PLUGIN_URL . 'assets/js/blocks/gateways/ecpay/credit-installment-24.js', $script_asset['dependencies'], $script_asset['version'], true);
