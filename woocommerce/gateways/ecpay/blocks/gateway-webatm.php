...
final class RY_ECPay_Gateway_Webatm_Blocks_Support extends RY_WTP_AbstractPaymentMethodType
{
    protected $name = RY_ECPay_Gateway_Webatm::ID;
    ...
    public function get_payment_method_script_handles()
    {
        ...
        wp_localize_script('ry-ecpay-webatm-block', 'RyEcpayWebatmBlockParams', [
            'defaultTitle' => __('ECPay WebATM', 'ry-woocommerce-tools-pro'),
        ]);
