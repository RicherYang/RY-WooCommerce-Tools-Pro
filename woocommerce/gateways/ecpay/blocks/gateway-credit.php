...
final class RY_ECPay_Gateway_Credit_Blocks_Support extends AbstractPaymentMethodType
{
    ...
    {
        $script_asset = include RY_WTP_PLUGIN_DIR . 'assets/js/blocks/gateways/ecpay/credit.asset.php';

        wp_register_script('ry-ecpay-credit-block', RY_WTP_PLUGIN_URL . 'assets/js/blocks/gateways/ecpay/credit.js', $script_asset['dependencies'], $script_asset['version'], true);
