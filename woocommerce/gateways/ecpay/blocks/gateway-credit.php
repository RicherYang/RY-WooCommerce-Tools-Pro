...
final class RY_ECPay_Gateway_Credit_Blocks_Support extends RY_WTP_AbstractPaymentMethodType
{
    protected $name = RY_ECPay_Gateway_Credit::ID;
    ...
    public function get_payment_method_script_handles()
    {
        ...
        wp_localize_script('ry-ecpay-credit-block', 'RyEcpayCreditBlockParams', [
            'defaultTitle' => __('ECPay Credit', 'ry-woocommerce-tools-pro'),
        ]);
