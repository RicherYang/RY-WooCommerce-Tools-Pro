...
class RY_ECPay_Gateway_Zingala extends RY_WT_WC_ECPay_Payment_Gateway
{
    public const ID = 'ry_ecpay_zingala';

    public const PAYMENT_TYPE = 'BNPL';

    public const SUB_PAYMENT_TYPE = 'ZINGALA';
    ...
    public function __construct()
    {
        ...
        $this->order_button_text = __('Pay via Zingala', 'ry-woocommerce-tools-pro');
        $this->method_title = __('ECPay Zingala', 'ry-woocommerce-tools-pro');
        $this->method_description = '';
        $this->process_payment_note = __('Pay via ECPay Zingala', 'ry-woocommerce-tools-pro');
