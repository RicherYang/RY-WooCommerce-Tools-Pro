...
final class RY_WTP_WC_NewebPay_Gateway extends RY_WTP_Gateway_Model
{
    ...
    protected function do_init(): void
    {
        ...
        if ('yes' === RY_WTP::get_option('newebpay_independent_digital', 'no')) {
            ...
            include_once RY_WTP_PLUGIN_DIR . 'woocommerce/gateways/newebpay/gateway-digital.php';
        }
    ...
    public function add_method($methods)
    {
        ...
        if ('yes' === RY_WTP::get_option('newebpay_independent_digital', 'no')) {
            ...
            $methods[] = 'RY_NewebPay_Gateway_Digital';
        }
    ...
    public function add_credit_settings($settings)
    {
        ...
        $settings['ae'] = [
            'title' => __('AE', 'ry-woocommerce-tools-pro'),
            'label' => __('Support AE', 'ry-woocommerce-tools-pro'),
            'type' => 'checkbox',
            'default' => 'no',
        ];
        $settings['union'] = [
