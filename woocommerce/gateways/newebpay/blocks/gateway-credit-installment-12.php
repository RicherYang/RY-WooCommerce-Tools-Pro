...
final class RY_NewebPay_Gateway_Credit_Installment_12_Blocks_Support extends RY_WTP_AbstractPaymentMethodType
{
    protected $name = RY_NewebPay_Gateway_Credit_Installment_12::ID;

    public function initialize()
    {
        $this->settings = get_option('woocommerce_ry_newebpay_credit_installment_12_settings', []);
    }
    ...
    public function get_payment_method_script_handles()
    {
        ...
        wp_localize_script('ry-newebpay-credit-installment-12-block', 'RyNewebpayCreditInstallment12BlockParams', [
            'defaultTitle' => __('NewebPay Credit (12 installment)', 'ry-woocommerce-tools-pro'),
        ]);
