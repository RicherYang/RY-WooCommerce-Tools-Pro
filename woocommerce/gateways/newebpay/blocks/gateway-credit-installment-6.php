...
final class RY_NewebPay_Gateway_Credit_Installment_6_Blocks_Support extends RY_WTP_AbstractPaymentMethodType
{
    protected $name = RY_NewebPay_Gateway_Credit_Installment_6::ID;
    ...
    public function get_payment_method_script_handles()
    {
        ...
        wp_localize_script('ry-newebpay-credit-installment-6-block', 'RyNewebpayCreditInstallment6BlockParams', [
            'defaultTitle' => __('NewebPay Credit (6 installment)', 'ry-woocommerce-tools-pro'),
        ]);
