...
{
    protected $name = RY_NewebPay_Gateway_Credit_Installment_18::ID;
    ...
    public function get_payment_method_script_handles()
    {
        ...
        wp_localize_script('ry-newebpay-credit-installment-18-block', 'RyNewebpayCreditInstallment18BlockParams', [
            'defaultTitle' => __('NewebPay Credit (18 installment)', 'ry-woocommerce-tools-pro'),
        ]);
