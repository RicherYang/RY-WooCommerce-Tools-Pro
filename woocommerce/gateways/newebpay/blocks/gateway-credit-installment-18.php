...
final class RY_NewebPay_Gateway_Credit_Installment_18_Blocks_Support extends AbstractPaymentMethodType
{
    ...
    {
        $script_asset = include RY_WTP_PLUGIN_DIR . 'assets/js/blocks/gateways/newebpay/credit-installment-18.asset.php';

        wp_register_script('ry-newebpay-credit-installment-18-block', RY_WTP_PLUGIN_URL . 'assets/js/blocks/gateways/newebpay/credit-installment-18.js', $script_asset['dependencies'], $script_asset['version'], true);
