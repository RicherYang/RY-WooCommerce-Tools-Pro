...
final class RY_WTP_WC_NewebPay_Gateway_Admin
{
    private static ?self $_instance = null;

    public static function instance(): RY_WTP_WC_NewebPay_Gateway_Admin
    {
    ...
    {
        include_once RY_WTP_PLUGIN_DIR . 'woocommerce/gateways/newebpay/includes/ajax.php';

        RY_WTP_WC_NewebPay_Gateway_Admin_ajax::instance();
        ...
        if ($current_section == 'newebpay_gateway') {
            ...
            array_splice($settings, $setting_idx, 0, [
                ...
                [
                    ...
                    'id' => Main::get_prefix_name('newebpay_independent_credit_installment'),
                    'type' => 'checkbox',
                    'default' => 'no',
                ...
                [
                    'id' => Main::get_prefix_name('newebpay_independent_digital'),
                    'type' => 'checkbox',
                    'default' => 'no',
                ...
                [
                    ...
                    'id' => Main::get_prefix_name('newebpay_email_payment_info'),
                    'type' => 'checkbox',
                    'default' => 'no',
                    'desc' => sprintf(
