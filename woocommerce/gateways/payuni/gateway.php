...
final class RY_WTP_WC_PAYUNi_Gateway
{
    protected static ?self $_instance = null;

    public static function instance(): RY_WTP_WC_PAYUNi_Gateway
    {
    ...
    protected function do_init(): void
    {
        ...
        include_once RY_WTP_PLUGIN_DIR . 'woocommerce/gateways/payuni/gateway-credit-installment-12.php';
        ...
        if (is_admin()) {
            ...
            RY_WTP_WC_PAYUNi_Gateway_Admin::instance();
        }

        add_filter('woocommerce_payment_gateways', [$this, 'add_method']);

        if ('yes' === RY_WTP::get_option('payuni_email_payment_info', 'yes')) {
    ...
    public function add_method($methods)
    {
        ...
        if ('yes' === RY_WTP::get_option('payuni_credit_installment', 'no')) {
            ...
            $methods[] = 'RY_PAYUNi_Gateway_Credit_Installment_12';
    ...
    public function add_payment_info($order, $sent_to_admin, $plain_text, $email)
    {
        if ($email->id == 'customer_on_hold_order') {
            switch ($order->get_payment_method()) {
                case 'ry_payuni_atm':
                    $template_file = 'emails/email-order-payuni-payment-info-atm.php';
                    break;
                case 'ry_payuni_cvs':
                    $template_file = 'emails/email-order-payuni-payment-info-cvs.php';
                    break;
            }
