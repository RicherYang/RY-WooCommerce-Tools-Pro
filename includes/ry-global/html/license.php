...
<table class="form-table">
    <tbody>
        <tr>
            <th>
                <label for="key-<?php echo hash('sha1', $basename); ?>">授權金鑰</label>
            </th>
            <td>
                <input class="regular-text" name="key-<?php echo hash('sha1', $basename); ?>" id="key-<?php echo hash('sha1', $basename); ?>" type="text" value="<?php echo esc_attr($key); ?>">
                <?php if (!empty($expire)) {
                    printf(
