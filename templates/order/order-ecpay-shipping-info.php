...
?>
<h2 class="woocommerce-order-details__title"><?=__('Shipping details', 'ry-woocommerce-tools-pro') ?></h2>

<table class="woocommerce-table woocommerce-table--shipping-details shop_table shipping_details">
	<thead>
		<tr>
			<th class="woocommerce-table__shipping-no shipping-no"><?=__('Shipping payment no', 'ry-woocommerce-tools-pro') ?></th>
			<th class="woocommerce-table__shipping-status shipping-status"><?=__('Shipping status', 'ry-woocommerce-tools-pro') ?></th>
		</tr>
	</thead>
	<tbody>
		<?php foreach( $shipping_info_list as $shipping_info ) { ?>
			<tr>
				...
				<td class="woocommerce-table__shipping-status shipping-status">
					...
					} elseif( in_array($shipping_info['status'], apply_filters('ry_ecpay_shipping_status_info_transporting', [2024, 2030, 2068, 3024, 3032])) ) {
					...
					} elseif( in_array($shipping_info['status'], apply_filters('ry_ecpay_shipping_status_info_completed', [2067, 3022])) ) {
