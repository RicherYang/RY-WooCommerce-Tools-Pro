...
// phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
echo esc_html__('Barcode 1', 'ry-woocommerce-tools') . "\t " . esc_html($order->get_meta('_smilepay_barcode_Barcode1')) . "\n";
// phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
echo esc_html__('Barcode 2', 'ry-woocommerce-tools') . "\t " . esc_html($order->get_meta('_smilepay_barcode_Barcode2')) . "\n";
// phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
echo esc_html__('Barcode 3', 'ry-woocommerce-tools') . "\t " . esc_html($order->get_meta('_smilepay_barcode_Barcode3')) . "\n";
