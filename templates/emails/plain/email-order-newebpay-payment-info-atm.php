...
// phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
echo esc_html__('Bank', 'ry-woocommerce-tools') . "\t " . esc_html(rywt_bank_code_to_name($order->get_meta('_newebpay_atm_BankCode'))) . "\n";
// phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
echo esc_html__('Bank code', 'ry-woocommerce-tools') . "\t " . esc_html($order->get_meta('_newebpay_atm_BankCode')) . "\n";
// phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
echo esc_html__('ATM Bank account', 'ry-woocommerce-tools') . "\t " . esc_html(wordwrap($order->get_meta('_newebpay_atm_vAccount'), 4, ' ', true)) . "\n";
