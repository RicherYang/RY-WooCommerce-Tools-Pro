...
<?php
/**
 * This template can be overridden by copying it to yourtheme/woocommerce/emails/email-order-payuni-payment-info-atm.php
 *
        ...
        <tbody>
            <tr>
                <th class="td" scope="row" style="text-align:<?php echo esc_attr($text_align); ?>;">
                    <?php esc_html_e('Bank', 'ry-woocommerce-tools-pro'); ?>
                </th>
            ...
            <tr>
                <th class="td" scope="row" style="text-align:<?php echo esc_attr($text_align); ?>;">
                    <?php esc_html_e('Bank code', 'ry-woocommerce-tools-pro'); ?>
                </th>
                <td class="td" style="text-align:<?php echo esc_attr($text_align); ?>;">
            ...
            <tr>
                <th class="td" scope="row" style="text-align:<?php echo esc_attr($text_align); ?>;">
                    <?php esc_html_e('ATM Bank account', 'ry-woocommerce-tools-pro'); ?>
                </th>
                <td class="td" style="text-align:<?php echo esc_attr($text_align); ?>;">
