...
<div style="margin-bottom: 40px;">
	<table class="td" cellspacing="0" cellpadding="6" style="width: 100%;" border="1">
		<tbody>
			<tr>
				<th class="td" scope="row" style="text-align:<?=esc_attr($text_align) ?>;"><?=__('Barcode 1', 'ry-woocommerce-tools') ?></th>
				<td class="td" style="text-align:<?=esc_attr($text_align) ?>;">
					<span><?=$order->get_meta('_ecpay_barcode_Barcode1') ?></span>
				</td>
			</tr>
			<tr>
				<th class="td" scope="row" style="text-align:<?=esc_attr($text_align) ?>;"><?=__('Barcode 2', 'ry-woocommerce-tools') ?></th>
				<td class="td" style="text-align:<?=esc_attr($text_align) ?>;">
					<span><?=$order->get_meta('_ecpay_barcode_Barcode2') ?></span>
				</td>
			</tr>
			<tr>
				<th class="td" scope="row" style="text-align:<?=esc_attr($text_align) ?>;"><?=__('Barcode 3', 'ry-woocommerce-tools') ?></th>
				<td class="td" style="text-align:<?=esc_attr($text_align) ?>;">
