...
<?php
/**
 * This template can be overridden by copying it to yourtheme/woocommerce/emails/email-order-payuni-payment-info-cvs.php
 *
...
?>
<h2><?php esc_html_e('Payment details', 'ry-woocommerce-tools'); // phpcs:ignore WordPress.WP.I18n.TextDomainMismatch?>
</h2>
        ...
        <tbody>
            <tr>
                <th class="td" scope="row" style="text-align:<?php echo esc_attr($text_align); ?>;">
                    <?php esc_html_e('CVS code', 'ry-woocommerce-tools'); // phpcs:ignore WordPress.WP.I18n.TextDomainMismatch?>
                </th>
